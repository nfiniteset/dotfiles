...
then
  ...
  alias gropus="$brew_prefix/bin/ggropus"
  ...
  alias ls="$brew_prefix/bin/gls -F --color"
  alias l="$brew_prefix/bin/gls -lAh --color"
  alias ll="$brew_prefix/bin/gls -l --color"
  alias la='$brew_prefix/bin/gls -A --color'
